...
public class RootEdit : ScriptableObject
{
    ...
    private Matter CreateMatter(string elementName)
    {
        ...
        matter.ID = System.Guid.NewGuid().ToString();
        matter.Name = elementName;
    ...
    private Creature CreateCreature(string elementName)
{
    ...
    creature.ID = System.Guid.NewGuid().ToString();
    creature.Name = elementName;
...
private Concept CreateConcept(string elementName)
{
    ...
    concept.ID = System.Guid.NewGuid().ToString();
...
{
    God god = new God();
    god.ID = System.Guid.NewGuid().ToString();
    god.Name = elementName;
...
private Event CreateEvent(string elementName)
{
    ...
    newEvent.ID = System.Guid.NewGuid().ToString();
...
private Collective CreateCollective(string elementName)
{
    ...
    collective.ID = System.Guid.NewGuid().ToString();
    collective.Name = elementName;
...
private Territory CreateTerritory(string elementName)
{
    ...
    territory.ID = System.Guid.NewGuid().ToString();
    territory.Name = elementName;
...
private Title CreateTitle(string elementName)
{
    ...
    title.ID = System.Guid.NewGuid().ToString();
    title.Name = elementName;
...
private Institution CreateInstitution(string elementName)
{
    ...
    institution.ID = System.Guid.NewGuid().ToString();
    institution.Name = elementName;
...
{
    Race race = new Race();
    race.ID = System.Guid.NewGuid().ToString();
    race.Name = elementName;
...
private Ability CreateAbility(string elementName)
{
    ...
    ability.ID = System.Guid.NewGuid().ToString();
    ability.Name = elementName;
